...
from action.custom_actions import CarryObjectTogether, DropObjectTogether, RemoveObjectTogether
import numpy as np

from matrx.messages import Message


class HumanCustomBrain(HumanAgentBrain):
    ...
    def decide_on_action(self, state, user_input):
        ...
        elif action == RemoveAlone.__name__:
            # Assign it to the arguments list
            # Set drop range
