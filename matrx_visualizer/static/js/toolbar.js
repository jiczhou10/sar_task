...
function add_message(chatroom_ID, mssg) {
    ...
    mssg_content = mssg_content.replaceAll("rock1.png", "<img src='/static/images/rock1.png' height=25 width=25/>");
    mssg_content = mssg_content.replaceAll("triangle.png", "<img src='/static/images/triangle.png' height=25 width=25/>");
    mssg_content = mssg_content.replaceAll("tree.png", "<img src='/static/images/tree.png' height=25 width=25/>");
    mssg_content = mssg_content.replaceAll("large_rock_.png", "<img src='/static/images/large_rock_.png' height=25 width=25/>");
    mssg_content = mssg_content.replaceAll("tall.png", "<img src='/static/images/tall.png' height=25 width=25/>");
    mssg_content = mssg_content.replaceAll("healthy_victim.png", "<img src='/static/images/healthy_victim.png' height=25 width=25/>");
    mssg_content = mssg_content.replaceAll("injured_victim.png", "<img src='/static/images/injured_victim.png' height=25 width=25/>");
    mssg_content = mssg_content.replaceAll("critical_victim.png", "<img src='/static/images/critical_victim.png' height=25 width=25/>");
    mssg_content = mssg_content.replaceAll("robot.png", "<img src='/static/images/robot.png' height=25 width=25/>");

    mssg_content = mssg_content.replaceAll("wall.png", "<img src='/static/images/Untitled.png' height=25 width=25/>");
    mssg_content = mssg_content.replaceAll("wall2.png", "<img src='/static/images/Untitled_2.png' height=25 width=25/>");


    mssg_content = mssg_content.replaceAll("A1.svg", "<img src='/static/images/A1.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("A2.svg", "<img src='/static/images/A2.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("A3.svg", "<img src='/static/images/A3.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("A4.svg", "<img src='/static/images/A4.svg' height=15 width=15/>");

    mssg_content = mssg_content.replaceAll("B1.svg", "<img src='/static/images/B1.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("B2.svg", "<img src='/static/images/B2.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("B3.svg", "<img src='/static/images/B3.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("B4.svg", "<img src='/static/images/B4.svg' height=15 width=15/>");

    mssg_content = mssg_content.replaceAll("C1.svg", "<img src='/static/images/C1.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("C2.svg", "<img src='/static/images/C2.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("C3.svg", "<img src='/static/images/C3.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("C4.svg", "<img src='/static/images/C4.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("C5.svg", "<img src='/static/images/C5.svg' height=15 width=15/>");

    mssg_content = mssg_content.replaceAll("D1.svg", "<img src='/static/images/D1.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("D2.svg", "<img src='/static/images/D2.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("D3.svg", "<img src='/static/images/D3.svg' height=15 width=15/>");
    mssg_content = mssg_content.replaceAll("D4.svg", "<img src='/static/images/D4.svg' height=15 width=15/>");

    mssg_content = mssg_content.replaceAll("human.png", "<img src='/static/images/human.png' height=25 width=25/>");
    mssg_content = mssg_content.replaceAll("agent.png", "<img src='/static/images/robot.png' height=25 width=25/>");

    mssg_content = mssg_content.replaceAll("3_left.svg", "<img src='/static/images/3_left.svg' height=25 width=150/>");
    mssg_content = mssg_content.replaceAll("2_left.svg", "<img src='/static/images/2_left.svg' height=25 width=150/>");
    mssg_content = mssg_content.replaceAll("1_left.svg", "<img src='/static/images/1_left.svg' height=25 width=150/>");

//    mssg_content = mssg_content.replaceAll("sar_bot", "SaR bot");
